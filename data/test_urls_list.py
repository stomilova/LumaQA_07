...
# может быть использовано всеми, кому нужно сделать тесты на наличие элемента на каждой странице сайта, документ может быть переименован по усмотрению,
# и дополнен большим колличеством страницу
TEST_URL_LIST = [
